 ...
 *
 * Demonstrates:
 *   - Slab-based range checking with nested if-else
 *   - Input validation (0–100)
 *   - Multiple output fields derived from a single input
 *
 * Connected to Day 4: the same grade logic will be rebuilt using switch
 * on pre-calculated ranges to compare readability.
 *
